...
def FM_pass_hetero_dummy(hypergraph,
        ...
        # else:
        #     nm = None
        hypergraph = map_counts_and_configs_hetero(hypergraph, assignment, num_partitions, network, costs, assignment_map=assignment_map, node_map=None, dummy_nodes=dummy_nodes)
...
def run_FM_hetero_dummy(
    ...
    # if costs is None: 
    #     if num_partitions + len(dummy_nodes) < 12:
    #         print("Config length:", len(node_map))
